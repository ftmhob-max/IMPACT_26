...
export function ProgressBar({ answered, total }: ProgressBarProps) {
  ...
  return (
    <div className="quiz-progress bg-white/95 backdrop-blur-sm border-t border-black/5 px-5 flex items-center gap-2.5 py-2">
      <div className="flex-1 h-[8px] rounded-full overflow-hidden" style={{ background: "#e8e7e0" }}>
        <div
      ...
      <div className="text-[11px] text-[#4a4a46] min-w-[54px] text-right font-semibold">
        {answered} / {total}
      </div>
    </div>
  );
