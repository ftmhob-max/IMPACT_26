...
const deleteSourceLinksForCourseRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
exports.deleteSourceLinksForCourseRef = deleteSourceLinksForCourseRef;

exports.deleteSourceLinksForCourse = function deleteSourceLinksForCourse(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
  return executeMutation(deleteSourceLinksForCourseRef(dcInstance, inputVars));
}
;

const deleteUserCourseProgressForCourseRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
exports.deleteUserCourseProgressForCourseRef = deleteUserCourseProgressForCourseRef;

exports.deleteUserCourseProgressForCourse = function deleteUserCourseProgressForCourse(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
...
const removeQuestionFromQuizRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
exports.removeQuestionFromQuizRef = removeQuestionFromQuizRef;

exports.removeQuestionFromQuiz = function removeQuestionFromQuiz(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
  return executeMutation(removeQuestionFromQuizRef(dcInstance, inputVars));
}
;

const reorderQuizQuestionRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return mutationRef(dcInstance, 'ReorderQuizQuestion', inputVars);
}
reorderQuizQuestionRef.operationName = 'ReorderQuizQuestion';
exports.reorderQuizQuestionRef = reorderQuizQuestionRef;

exports.reorderQuizQuestion = function reorderQuizQuestion(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
...
const updateUserCourseProgressRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
exports.updateUserCourseProgressRef = updateUserCourseProgressRef;

exports.updateUserCourseProgress = function updateUserCourseProgress(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
...
const updateLessonPlaybackRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return mutationRef(dcInstance, 'UpdateLessonPlayback', inputVars);
}
updateLessonPlaybackRef.operationName = 'UpdateLessonPlayback';
exports.updateLessonPlaybackRef = updateLessonPlaybackRef;

exports.updateLessonPlayback = function updateLessonPlayback(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
  return executeMutation(updateLessonPlaybackRef(dcInstance, inputVars));
}
;

const completeLessonProgressRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
exports.completeLessonProgressRef = completeLessonProgressRef;

exports.completeLessonProgress = function completeLessonProgress(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
  return executeMutation(completeLessonProgressRef(dcInstance, inputVars));
}
;

const recordDailyActivityRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return mutationRef(dcInstance, 'RecordDailyActivity', inputVars);
}
recordDailyActivityRef.operationName = 'RecordDailyActivity';
exports.recordDailyActivityRef = recordDailyActivityRef;

exports.recordDailyActivity = function recordDailyActivity(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
...
exports.deleteCohortMembershipsForCohortRef = deleteCohortMembershipsForCohortRef;

exports.deleteCohortMembershipsForCohort = function deleteCohortMembershipsForCohort(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
  return executeMutation(deleteCohortMembershipsForCohortRef(dcInstance, inputVars));
}
;

const deleteCohortInstructorsForCohortRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
exports.deleteCohortInstructorsForCohortRef = deleteCohortInstructorsForCohortRef;

exports.deleteCohortInstructorsForCohort = function deleteCohortInstructorsForCohort(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
  return executeMutation(deleteCohortInstructorsForCohortRef(dcInstance, inputVars));
}
;

const addCohortMembershipRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return mutationRef(dcInstance, 'AddCohortMembership', inputVars);
}
addCohortMembershipRef.operationName = 'AddCohortMembership';
exports.addCohortMembershipRef = addCohortMembershipRef;

exports.addCohortMembership = function addCohortMembership(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
  return executeMutation(addCohortMembershipRef(dcInstance, inputVars));
}
;

const removeCohortMembershipRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
exports.removeCohortMembershipRef = removeCohortMembershipRef;

exports.removeCohortMembership = function removeCohortMembership(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
  return executeMutation(removeCohortMembershipRef(dcInstance, inputVars));
}
;

const addCohortInstructorRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return mutationRef(dcInstance, 'AddCohortInstructor', inputVars);
}
addCohortInstructorRef.operationName = 'AddCohortInstructor';
exports.addCohortInstructorRef = addCohortInstructorRef;

exports.addCohortInstructor = function addCohortInstructor(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
  return executeMutation(addCohortInstructorRef(dcInstance, inputVars));
}
;

const removeCohortInstructorRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
exports.removeCohortInstructorRef = removeCohortInstructorRef;

exports.removeCohortInstructor = function removeCohortInstructor(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
...
const getLearnerCatalogRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'GetLearnerCatalog', inputVars);
}
getLearnerCatalogRef.operationName = 'GetLearnerCatalog';
exports.getLearnerCatalogRef = getLearnerCatalogRef;

exports.getLearnerCatalog = function getLearnerCatalog(dcOrVars, varsOrOptions, options) {
...
const getLearnerProfileRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'GetLearnerProfile', inputVars);
}
getLearnerProfileRef.operationName = 'GetLearnerProfile';
exports.getLearnerProfileRef = getLearnerProfileRef;

exports.getLearnerProfile = function getLearnerProfile(dcOrVars, varsOrOptions, options) {
...
const getPublishedCourseBySlugRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
exports.getPublishedCourseBySlugRef = getPublishedCourseBySlugRef;

exports.getPublishedCourseBySlug = function getPublishedCourseBySlug(dcOrVars, varsOrOptions, options) {
...
const listPublishedQuizzesRef = (dc) => {
  const { dc: dcInstance} = validateArgs(connectorConfig, dc, undefined);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'ListPublishedQuizzes');
}
listPublishedQuizzesRef.operationName = 'ListPublishedQuizzes';
exports.listPublishedQuizzesRef = listPublishedQuizzesRef;

exports.listPublishedQuizzes = function listPublishedQuizzes(dcOrOptions, options) {
...
const getQuizSummaryRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'GetQuizSummary', inputVars);
}
getQuizSummaryRef.operationName = 'GetQuizSummary';
exports.getQuizSummaryRef = getQuizSummaryRef;

exports.getQuizSummary = function getQuizSummary(dcOrVars, varsOrOptions, options) {
...
const listLearnerSourceMaterialsRef = (dc) => {
  const { dc: dcInstance} = validateArgs(connectorConfig, dc, undefined);
  dcInstance._useGeneratedSdk();
...
exports.listLearnerSourceMaterialsRef = listLearnerSourceMaterialsRef;

exports.listLearnerSourceMaterials = function listLearnerSourceMaterials(dcOrOptions, options) {
...
const getLearnerSourceMaterialAccessRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
exports.getLearnerSourceMaterialAccessRef = getLearnerSourceMaterialAccessRef;

exports.getLearnerSourceMaterialAccess = function getLearnerSourceMaterialAccess(dcOrVars, varsOrOptions, options) {
...
exports.getQuizById = function getQuizById(dcOrVars, varsOrOptions, options) {
...
const getUserActivityHistoryRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
exports.getUserActivityHistoryRef = getUserActivityHistoryRef;

exports.getUserActivityHistory = function getUserActivityHistory(dcOrVars, varsOrOptions, options) {
...
const adminListCohortsRef = (dc) => {
  const { dc: dcInstance} = validateArgs(connectorConfig, dc, undefined);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'AdminListCohorts');
}
adminListCohortsRef.operationName = 'AdminListCohorts';
exports.adminListCohortsRef = adminListCohortsRef;

exports.adminListCohorts = function adminListCohorts(dcOrOptions, options) {
...
const listCohortsForInstructorRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
exports.listCohortsForInstructorRef = listCohortsForInstructorRef;

exports.listCohortsForInstructor = function listCohortsForInstructor(dcOrVars, varsOrOptions, options) {
...
const getCohortDetailRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'GetCohortDetail', inputVars);
}
getCohortDetailRef.operationName = 'GetCohortDetail';
exports.getCohortDetailRef = getCohortDetailRef;

exports.getCohortDetail = function getCohortDetail(dcOrVars, varsOrOptions, options) {
...
const getCohortMemberIdsRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'GetCohortMemberIds', inputVars);
}
getCohortMemberIdsRef.operationName = 'GetCohortMemberIds';
exports.getCohortMemberIdsRef = getCohortMemberIdsRef;

exports.getCohortMemberIds = function getCohortMemberIds(dcOrVars, varsOrOptions, options) {
...
const getCohortAttemptsRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'GetCohortAttempts', inputVars);
}
getCohortAttemptsRef.operationName = 'GetCohortAttempts';
exports.getCohortAttemptsRef = getCohortAttemptsRef;

exports.getCohortAttempts = function getCohortAttempts(dcOrVars, varsOrOptions, options) {
...
const getCohortEngagementRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'GetCohortEngagement', inputVars);
}
getCohortEngagementRef.operationName = 'GetCohortEngagement';
exports.getCohortEngagementRef = getCohortEngagementRef;

exports.getCohortEngagement = function getCohortEngagement(dcOrVars, varsOrOptions, options) {
...
const getLearnerProgressDetailRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
exports.getLearnerProgressDetailRef = getLearnerProgressDetailRef;

exports.getLearnerProgressDetail = function getLearnerProgressDetail(dcOrVars, varsOrOptions, options) {
...
const adminGetAttemptReviewRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'AdminGetAttemptReview', inputVars);
}
adminGetAttemptReviewRef.operationName = 'AdminGetAttemptReview';
exports.adminGetAttemptReviewRef = adminGetAttemptReviewRef;

exports.adminGetAttemptReview = function adminGetAttemptReview(dcOrVars, varsOrOptions, options) {
