...
```js
import { createUser, updateUserRole, createCourse, updateCourse, createModule, updateModule, createLessonVersion, createLesson, updateLesson, deleteLesson } from '@impact26/dataconnect-sdk';
...
// Operation DeleteLesson:  For variables, look at type DeleteLessonVars in ../index.d.ts
