  ...
  try {
    ...
    return NextResponse.json({
      material: {
        ...
        displayStatus: hydrated.displayStatus,
        starred: hydrated.starred,
        archivedAt: hydrated.archivedAt,
        trashedAt: hydrated.trashedAt,
        reviewStatus: hydrated.reviewStatus,
        visibility: hydrated.visibility,
        duplicateOf: hydrated.duplicateOf,
        lastActivityAt: hydrated.lastActivityAt,
        folder: hydrated.folder,
        uploader: hydrated.uploader,
        tags: hydrated.tags,
